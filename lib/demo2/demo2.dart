...
class _MyHomePageState extends State<MyHomePage> {
  List allImgs = ['assets/demo2/pic1.jpg', 'assets/demo2/pic2.jpg'];
        ...
        body: ListView(
          children: <Widget>[
            ...
            Container(
              ...
              child: ListView(
                children: <Widget>[
                  _buildCard('Gounuli', 'assets/demo2/chris.jpg', '3.7', 'The newly decorated new house is well furnished and has a beautiful environment'),
                  _buildCard('Michelle', 'assets/demo2/hugh.jpg', '4.3',
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(7.0),
                              image: DecorationImage(
                                  image: AssetImage('assets/demo2/pic1.jpg'),
                                  fit: BoxFit.cover
                              )
                          ),
                        ),
