    ...
    return Scaffold(
        ...
        body: ListView(
          children: <Widget>[
            ...
            _listItem('assets/demo5/steak.png', 'Chocolate lemon cup cake', 'The sour and sweetness of the lemon neutralizes the sweetness of the cream', '\$18.0', 134, 2412, '2-3per'),
            SizedBox(height: 10.0),
            _listItem('assets/demo5/steak.png', 'Strawberry cupcake', 'Rich in taste, dense in taste, with a bit of bitterness in chocolate, it is a great...', '\$18.0', 134, 2412, '2-3per'),
